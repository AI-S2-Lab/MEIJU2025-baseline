...
--num_thread=8 --corpus=MEIJU_balance_Mandarin
--emo_output_dim=7 --int_output_dim=8 --track=1
--ce_weight=1.0 --focal_weight=1.0 --cls_layers=128,64 --dropout_rate=0.2
--niter=15 --niter_decay=45 --print_freq=10
--batch_size=32 --lr=2e-4 --run_idx=$run_idx --weight_decay=1e-5
--name=our_balance_Mandarin --suffix=run_{gpu_ids}_{run_idx} --has_test
--pretrained_path='/sdc/home/zuohaolin/zuohaolin/MEIJUChallenge/checkpoints/pretrain_balance_Mandarin_run_5_2' --best_cvNo=2
--cvNo=$i"
