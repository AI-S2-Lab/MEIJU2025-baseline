...
--name=our_balance_English --suffix=run_{gpu_ids}_{run_idx} --has_test
--pretrained_path='/sdc/home/zuohaolin/zuohaolin/MEIJUChallenge/checkpoints/pretrain_balance_English_run_4_1' --best_cvNo=1
--cvNo=$i"
